...
function decode(input2, options) {
  return decoder.decode(input2, options);
}
...
function resolveHostnameAndPort(input2) {
  const url2 = parse(input2);
...
var WebtorrentHub = class {
  ...
  #remoteAddr;
  constructor(ws2, infoHash, localAddr, remoteAddr) {
    if (remoteAddr) {
